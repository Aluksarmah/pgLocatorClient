...
function ConfirmReservation() {
  ...
  let differenceInDays =
    (new Date(checkOutDate) - new Date(checkInDate)) / (24 * 60 * 60 * 1000);
  let totalCost =
    listing.price * differenceInDays +
    100 +
    Math.ceil(listing.price * differenceInDays * 0.042);
  ...
  return (
    <div className="w-screen h-screen p-10 flex item-center justify-center bg-stone-200 pb-36 sm:pb-5">
      <div className="flex bg-white border rounded-lg w-full lg:w-3/5 lg:items-center lg:justify-center">
        <div className="w-1/2 p-5 m-3 border-2 border-sky-200 rounded-lg">
          ...
          <div className="mt-8 border-b-2">
            ...
            <div className="my-4 flex items-center justify-between">
              <h4 className="text-lg font-semibold my-2">Guests</h4>
              <p>{numGuests}</p>
            </div>
          </div>
          <p className="text-sm text-slate-400 mt-5">
            *** This is not a real payment system. Please do not enter real
            financial information. Click confirm reservation to continue ***
          </p>
          <h2 className="my-5 text-2xl font-semibold">Payment</h2>
